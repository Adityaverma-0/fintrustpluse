...
const STORIES = [
  ...
  },
  {
    ...
    avatar: "SC",
    quote: "As a client, FinTrust+ gave me confidence to hire internationally. The milestone system kept projects on track and the AI matched me with exactly the right developers.",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-br from-primary/5 via-background to-accent/10 py-20">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <span className="inline-block bg-primary/10 text-primary text-sm font-semibold px-4 py-1.5 rounded-full mb-4">Why FinTrust+</span>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Freelancing should feel safe.<br />Now it does.</h1>
            <p className="text-lg text-muted-foreground mb-8">
              We built FinTrust+ because we were tired of unpaid invoices, disappearing clients, and platforms that take 20% of every dollar. There's a better way.
            </p>
      ...
      <section className="py-20 container mx-auto px-4">
        <div className="text-center mb-14">
          <h2 className="text-3xl font-bold mb-3">6 reasons 500K+ people chose FinTrust+</h2>
      ...
      <section className="bg-secondary/50 py-20">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold mb-3">FinTrust+ vs the rest</h2>
          ...
          <div className="bg-card border rounded-2xl overflow-hidden">
            <div className="grid grid-cols-3 bg-primary text-white text-sm font-semibold">
              ...
              <div className="p-4 text-center">FinTrust+</div>
      ...
      <section className="bg-primary text-white py-16">
        <div className="container mx-auto px-4 text-center max-w-2xl">
          ...
          <p className="text-white/80 mb-8">Join 500,000+ professionals who work smarter with FinTrust+. Free to join, no credit card required.</p>
          <div className="flex items-center justify-center gap-4 flex-wrap">
